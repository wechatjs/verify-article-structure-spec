...
// const badcases = [
//     {
//     id: 'E_bPJ6cD9BJozDc2ggcdw',
//     url: 'https://mp.weixin.qq.com/s/-E_bPJ6cD9BJozDc2ggcdw',
...
const goodcases = [
  ...
  {
    id: 'Rh4HCBN5s8HIn-_CSNQnSQ',
    url: 'https://mp.weixin.qq.com/s/Rh4HCBN5s8HIn-_CSNQnSQ',
    desc: '反向用例 #3 - 用户认可的合规文章（防止规则误报）加data-ignore-width',
  }
];
