...
// Optional --verify path reuses check's puppeteer chain to report
 ...
 * check's div-container convention) and astToHtml emits only the content
...
export function runClean(html: string): string {
  ...
  // check passes a div container as the engine root. This also ensures
